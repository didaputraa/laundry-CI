...
function clear(){
    ...
    jQuery(".az-modal form select").not('.x-hidden').each(function(index, value) {
...
var format_number = ".";
var format_decimal = ",";
var db_format_decimal = "<?php echo az_get_config('decimal_format');?>";
...
jQuery(document).ready(function(){
    ...
    jQuery("body").on('keydown keyup', '.format-number-decimal', function(e) {
        ...
        if ($.inArray(e.keyCode, key_decimal) !== -1 ||
             // Allow: Ctrl+A, Command+A
            (e.keyCode == 65 && ( e.ctrlKey === true || e.metaKey === true ) ) || 
             // Allow: home, end, left, right, down, up
            (e.keyCode >= 35 && e.keyCode <= 40)) {
    ...
    jQuery("body").on('keyup keydown', '.format-number-minus', function(e){
        jQuery(this).val(thousand_separator(jQuery(this).val()));
        if ($.inArray(e.keyCode, [189, 46, 8, 9, 27, 13, 190]) !== -1 ||
             // Allow: Ctrl+A, Command+A
            (e.keyCode == 65 && ( e.ctrlKey === true || e.metaKey === true ) ) || 
             // Allow: home, end, left, right, down, up
            (e.keyCode >= 35 && e.keyCode <= 40)) {
